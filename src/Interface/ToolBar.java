...
public class ToolBar extends JPanel implements MouseListener {
    ...
    private void chooseFile() {
        ...
        FileNameExtensionFilter filtro = new FileNameExtensionFilter("Archivos MiniJ (*.minij)", "minij");
    ...
    private void createFile(String content) {
        ...
        if (seleccion == JFileChooser.APPROVE_OPTION) {
            olcFile = file.getSelectedFile();
            String name;
            String message = "Nombre del Archivo MiniJ [.minij]:";
            String path;
            ...
            do {
                ...
                if(name == null) break;
                    ...
                    message = "Debe Ingresar un Nombre.\nNombre del Archivo MiniJ [.minij]:";
                    continue;
                }
                path = olcFile.getAbsolutePath() + "\\" + name + ".minij";
